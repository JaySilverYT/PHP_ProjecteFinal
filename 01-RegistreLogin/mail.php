...
function enviarMailActivacio($email, $activationCode)
{
    ...
    $mail->Username = 'phpenviar@gmail.com';
    $mail->Password = 'PhpEnviar123!';

    //Dades del correu electrònic
    $mail->SetFrom('phpenviar@gmail.com', 'Cinetics - Sergio Hervas (Administrador)');
    ...
    <html>
        <body>
            ...
            <br>
            <a href="http://localhost/PracticaPt1SergioHervasDavidDelgado/01-RegistreLogin/mailCheckAccount.php?code='.$activationCode.'&mail='.$email.'">Active your account Now!</a>
            <hr>
...
function enviarMailResetPassword($email, $resetPassCode)
{
    ...
    <html>
        <body>
            ...
            <br>
            <a href="http://localhost/PracticaPt1SergioHervasDavidDelgado/01-RegistreLogin/resetPassword.php?code='.$resetPassCode.'&mail='.$email.'">I want to Reset My Password</a>
            <hr>
            <img src="https://www.pngplay.com/wp-content/uploads/13/Money-Heist-Mask-Free-PNG.png" width="75" height="75">
        </body>
    </html>';
